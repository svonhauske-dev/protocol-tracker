...
**Release ops.** Build 16 submitted to TestFlight (background, exit 0). Next build (17) will carry Phase 1 (PostHog + bulk-add) + Phase 2 to testers.
**Pending:** device-verify bulk-add + confirm PostHog events land (US region assumed); cut build 17; then Phase 3 (interaction guidance + Apple Health) per roadmap.
